      ...
      <View style={styles.container(theme)}>
        ...
        <View style={styles.itemContainer}>
          <View style={{ justifyContent: 'space-evenly' }}>
            ...
            <View>
              {order?.deliveredAt && <TextDefault textColor={theme.gray500} >{new Date(order?.deliveredAt).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })}</TextDefault>}
            </View>
          </View>
          <View>
